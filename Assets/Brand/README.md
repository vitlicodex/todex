...
- Ink: `#F6F8FB` for the main wordmark on dark backgrounds.
- Graphite: `#11161C` for dark surfaces.
- Token green: `#58F29A` for usage and positive numeric states.
- Crown gold: `#F6C453` for the crown and rare premium accents.
- Ocean: `#4CB3FF` and violet: `#A78BFA` are optional campaign colors.

## Logo Files

- `todex-logo-graphite.svg` - primary dark-background logo.
- `todex-logo-emerald.svg` - green-accent logo.
- `todex-logo-ocean.svg` - blue-accent logo.
- `todex-logo-violet.svg` - purple-accent logo.
- `todex-logo-mono.svg` - simple monochrome logo for light docs.
...
- Use the app icon generator for macOS icon updates: `swift Scripts/generate-app-icon.swift`.
